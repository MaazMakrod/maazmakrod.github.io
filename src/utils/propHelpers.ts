import {
  ...
  PulseOptions,
} from "../components/card-wrapper/styles";
...
const DEFAULT_BLOB_ANIMATION_OPTIONS = {
  timing: 10000,
  options: "cubic-bezier(0.68, -0.55, 0.27, 1.55) infinite alternate forwards",
};
...
export const generateCardWrapperProps = (
  ...
  const blobStyles = blob
    ? {
        ...
        [BREAKPOINTS.DEFAULT]: {
          "border-radius": startingBlobShape
            ? STARTING_BLOB_SHAPE[startingBlobShape]
            : STARTING_BLOB_SHAPE[0],
