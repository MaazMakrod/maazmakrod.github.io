import { BREAKPOINTS, mapCssToBreakpoints, mapStylesValuesToBreakpoints } from '../styles/helpers';
...
import { COLORS, CONTENT_HEIGHT, CONTENT_WIDTH, FONT, FONT_TYPES } from '../styles/theme';
import { Link } from '../icons';
import { generateCardWrapperProps, ICON_DEFAULT_PROPS } from '../utils/propHelpers';
import CardWrapper, { CardWrapperProps } from '../components/card-wrapper/CardWrapper';
      ...
      childComponents: [
        ...
        },
        {
            ...
            component: <ImageCard
                ...
                aspectRatio='4/3'
                imageWidth={{ [BREAKPOINTS.DEFAULT]: '100%', [BREAKPOINTS.LARGE]: '175px'}}
                imageHeight={{ [BREAKPOINTS.DEFAULT]: '100%', [BREAKPOINTS.LARGE]: '175px'}}
                objectFit='cover'
                lazyLoad
                cardWrapperProps={{
          ...
          },
          {
            ...
            component: (
                <CardWrapper {
                    ...
                    <StyledTypeWriterWrapper types={['h2', 'bold']} color={COLORS.white}>
                        I'm a 
                        <Typewriter
                            options={{
                                strings: [
